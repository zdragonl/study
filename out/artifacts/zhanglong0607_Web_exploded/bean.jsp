<%@ page import="com.zhanglong.week10.StringBean" %><%--
...
<body>
    ...
    <jsp:useBean id="bean" class="com.zhanglong.week10.StringBean" />
    <jsp:setProperty name="bean" property="message" value='<%= request.getParameter("message")%>' />
    <%
//        com.zhanglongng.week10.StringBean bean=new StringBean();//CHANGE with useBean -step -6
        //Step-4
