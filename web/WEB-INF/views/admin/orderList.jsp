		...
		<div class="table-responsive col-sm-10">
			<table class="table table-condensed">
				...
				<tr>
					...
					<td>order Date</td>
					<%
						com.zhanglong.model.Order o=(com.zhanglong.model.Order)pageContext.findAttribute("o");
						int userId=o.getCustomerId();
						java.sql.Connection con=(java.sql.Connection)application.getAttribute("con");
						com.zhanglong.dao.UserDao userDao=new com.zhanglong.dao.UserDao();
					...
					<td class="cart_total">
						<%
							...
							String paymentType=com.zhanglong.model.Payment.findByPaymentId(con,n);
						%>
